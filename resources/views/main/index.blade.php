              ...
              <div class="homepage owl-carousel">
                <div class="item">
                  <div class="row">
                    <div class="col-md-5 text-right">
                      <p><img src="assets/img/masau.JPG" alt="" class="ml-auto"></p>
                      <h1>Purpose</h1>
                      <p>We exist for the Ugandans working tirelessly in the diaspora to change their story. </p>
                    </div>
                ...
                <div class="item">
                  <div class="row">
                    <div class="col-md-5 text-right">
                      <h1>Vision</h1>
                      <p>Our vision is to be the leading accelerator of growth and investment of our people working and living in the diaspora across Africa, delivering exceptional client experiences and superior value.</p>
                    </div>
                ...
                <div class="item">
                  <div class="row">
                    ...
                    <div class="col-md-5">
                      <h1>Mission</h1>
                      <p>To change one story at a time. </p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="testimonial d-flex flex-wrap">
                ...
                <div class="bottom d-flex align-items-center justify-content-between align-self-end">
                  ...
                  <div class="testimonial-info d-flex">
                    ...
                    <div class="avatar"><img alt="" src="assets/img/person-1.jpg" class="img-fluid"></div>
                  </div>
                </div>
              </div>
            </li>
              ...
              <div class="testimonial d-flex flex-wrap">
                ...
                <div class="bottom d-flex align-items-center justify-content-between align-self-end">
                  ...
                  <div class="testimonial-info d-flex">
                    ...
                    <div class="avatar"><img alt="" src="assets/img/person-2.jpg" class="img-fluid"></div>
                  </div>
                </div>
              </div>
            </li>
              ...
              <div class="testimonial d-flex flex-wrap">
                ...
                <div class="bottom d-flex align-items-center justify-content-between align-self-end">
                  ...
                  <div class="testimonial-info d-flex">
                    ...
                    <div class="avatar"><img alt="" src="assets/img/person-3.png" class="img-fluid"></div>
                  </div>
                </div>
              </div>
            </li>
              ...
              <div class="testimonial d-flex flex-wrap">
                ...
                <div class="bottom d-flex align-items-center justify-content-between align-self-end">
                  ...
                  <div class="testimonial-info d-flex">
                    ...
                    <div class="avatar"><img alt="" src="assets/img/person-4.jpg" class="img-fluid"></div>
                  </div>
                </div>
              </div>
            </li>
